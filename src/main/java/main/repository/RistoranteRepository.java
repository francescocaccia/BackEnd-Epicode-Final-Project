...
//    List<Ristorante> findByLuogoAndNomeRistorante(String city, String restaurantName);

    // List<Ristorante> findByLuogoCittaAndNomeRistoranteContainingIgnoreCase(String citta, String nomeRistorante);
}
